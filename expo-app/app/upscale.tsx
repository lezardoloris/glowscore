...
import { upscale } from '../src/services/featureService';
...
export default function UpscaleScreen() {
  ...
  async function generate() {
    ...
    try {
      ...
      const resultUrl = await upscale(imageUri);
      router.push({
        pathname: '/result',
        params: { imageUri, resultUri: resultUrl, styleId: 'upscale', isHD: 'true' },
      });
    } catch (e: any) {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.title}>4K Upscale</Text>
      <Text style={styles.subtitle}>Enhance your photo to crisp 4K resolution</Text>
      ...
      <View style={styles.infoList}>
        <View style={styles.infoRow}>
          ...
          <Text style={styles.infoText}>AI-powered detail enhancement</Text>
        </View>
        <View style={styles.infoRow}>
          <Text style={styles.infoIcon}>HD</Text>
          <Text style={styles.infoText}>Sharpens faces and textures</Text>
        </View>
        <View style={styles.infoRow}>
          <Text style={styles.infoIcon}>4K</Text>
          <Text style={styles.infoText}>Up to 4x resolution boost</Text>
        </View>
      </View>
      ...
      <Pressable
        ...
        disabled={loading}
      >
        <Text style={styles.ctaText}>{loading ? 'Upscaling...' : 'Upscale to 4K'}</Text>
      </Pressable>

      <Text style={styles.disclaimer}>
        Uses AI super-resolution to enhance image quality and detail.
      </Text>
    </ScrollView>
  );
}
